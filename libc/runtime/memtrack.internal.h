...
#define kMemtrackFdsStart   _kMemVista(0x6fe000040000, 0x05e000040000)
#define kMemtrackFdsSize    \
  (_kMemVista(0x6feffffc0000, 0x05effffc0000) - kMemtrackFdsStart)
#define kMemtrackZiposStart _kMemVista(0x6fd000040000, 0x05d000040000)
#define kMemtrackZiposSize  \
  (_kMemVista(0x6fdffffc0000, 0x05dffffc0000) - kMemtrackZiposStart)
#define kMemtrackNsyncStart _kMemVista(0x6fc000040000, 0x05c000040000)
#define kMemtrackNsyncSize  \
  (_kMemVista(0x6fcffffc0000, 0x05cffffc0000) - kMemtrackNsyncStart)
